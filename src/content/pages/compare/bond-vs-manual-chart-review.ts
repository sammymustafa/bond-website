      ...
      blocks: [
        ...
        },
        {
          ...
          rows: [
            ...
            ["Setup", "Under 2 weeks for a pilot on a list the site already has; 4 to 6 weeks for full EHR integration, depending on the EHR, IT review and interface method, with Bond's implementation team handling it end to end and no integration fee{{cite:bond-site,bond-product}}", "Trained staff and a screening log{{cite:unlu-2024-rectifier,ich-e6r3}}"],
          ],
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "**Starting before any EHR connection.** A pilot can run outreach, pre-screening and scheduling on a list the site already has, such as ad leads, referrals or registry contacts, with setup in under 2 weeks. Full EHR integration takes 4 to 6 weeks, and Bond's implementation team handles it end to end.{{cite:bond-site}}",
          ],
        },
      ],
    },
